...
- Updated Formspree action URL to `https://formspree.io/f/mwvdzpep`
- Added orange-tinted prompt box above no-walkins notice: "For best results, contact us directly..."
- Both info boxes styled with orange tint bg, orange left accent, matching font sizes
- Top box has white border
- "GET DIRECTIONS" button now links to Google Maps directions (opens new tab)

### Homepage
- "ROUTE" button now links to Google Maps directions (opens new tab)
...
- Elfsight widgets need real App IDs to go live
- Bio text is still dummy lorem ipsum
